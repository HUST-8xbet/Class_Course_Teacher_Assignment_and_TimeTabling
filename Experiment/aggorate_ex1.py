...
# =====================================================================
BASE_DIR = "Result/Experiment1_Rho"
OUTPUT_CSV = "BaoCao_SoSanh_Experiment1_Rho.csv"

# Danh sách các thư mục chứa kịch bản
RHO_FOLDERS = ["Rho_0.1", "Rho_0.2", "Rho_0.5", "Rho_0.9"]
...
def aggregate_experiment1():
    ...
    csv_columns = [
        ...
        "Điểm_Rho_0.1", "Time_Rho_0.1(s)",
        "Điểm_Rho_0.2", "Time_Rho_0.2(s)",
        "Điểm_Rho_0.5", "Time_Rho_0.5(s)",
        "Điểm_Rho_0.9", "Time_Rho_0.9(s)"
    ]
    ...
    print(f"\n✅ HOÀN TẤT! File bảng chéo so sánh Experiment 1 đã được tạo tại: {OUTPUT_CSV}")

if __name__ == "__main__":
    aggregate_experiment1()